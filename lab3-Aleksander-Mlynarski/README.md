...
2. Nie należy edytować pliku test_main.py.
...
5. Środowisko programistyczne do laboratorium jest sprawą indywidualną studenta, rekomendowany jest edytor VS Code.
6. W razie jakichkolwiek niejasności należy skontaktować się z prowadzącym zajęcia.
