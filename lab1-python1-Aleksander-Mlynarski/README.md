# LAB1
Podczas zajęć laboratoryjnych przypomnisz sobie podstawy pracy w języku Python, utrwalając najważniejsze elementy składni i zasady programowania, nauczysz się korzystać z notebooków jupyterowych, które umożliwiają wygodne łączenie kodu, obliczeń i komentarzy w jednym środowisku, odświeżysz umiejętność tworzenia i wykorzystywania funkcji, co pozwoli Ci pisać bardziej przejrzysty i modularny kod, powtórzysz podstawowe zagadnienia z algebry liniowej, takie jak tworzenie wektorów i macierzy oraz wykonywanie na nich podstawowych działań, niezbędnych do dalszych analiz i obliczeń.
# Wstęp do Pythona
